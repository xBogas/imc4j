...
public class DepthBinnedProfiler<T extends Message> implements DataProfiler<T> {
    ...
    final ArrayList<ProfileSample> samples = new ArrayList<>();
    ...
    @Override
    public ArrayList<Message> getProfile(VerticalProfile.PARAMETER param, int numDepths) {
    ...
    public static void main(String[] args) {
        DepthBinnedProfiler<Salinity> profiler = new DepthBinnedProfiler<>();
        ...
        ArrayList<Message> list = profiler.getProfile(PARAMETER.PROF_SALINITY, 20);
